...
export const DEFAULT_TOURS = [
  ...
  { id: "legacy-23", label: "AAT NON OP", name: "AAT NON OP", time: "", aliases: [], legacyIndex: 23, active: true, reportable: false },
  { id: "legacy-24", label: "ALL SWIM NON OP", name: "ALL SWIM NON OP", time: "", aliases: [], legacyIndex: 24, active: true, reportable: false },
  { id: "legacy-25", label: "UAE NON OP", name: "UAE NON OP", time: "", aliases: [], legacyIndex: 25, active: true, reportable: false },
];
